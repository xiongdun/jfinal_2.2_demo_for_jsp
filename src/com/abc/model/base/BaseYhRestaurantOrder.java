...
public abstract class BaseYhRestaurantOrder<M extends BaseYhRestaurantOrder<M>> extends Model<M> implements IBean {
	...
	public void setRestName(java.lang.String restName) {
		set("rest_name", restName);
	}

	public java.lang.String getRestName() {
		return get("rest_name");
	}
