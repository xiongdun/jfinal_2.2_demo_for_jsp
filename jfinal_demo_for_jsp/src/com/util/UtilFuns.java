...
/** UtilFuns is a JavaBean.  */
 public class UtilFuns {
  ...
  static public String newLine(){
   ...
   public static Integer isPage(Integer page){
	   if(page == null){
		   page = 0;
	   }
	   return page;
 ...
 */
  ...
  */
  ...
  public static void formatArrayList(ArrayList al) {
     ...
     */
    public static String ComboList(String CurrentValue, String[] content) {
      int i = 0;
      StringBuffer sBuf = new StringBuffer();
    ...
    public static String ComboListMust(String CurrentValue, String[] content) {
      int i = 0;
      StringBuffer sBuf = new StringBuffer();
      String selected = " selected";
      try{
	...
	%>
     */
    public static String ComboList(String CurrentValue,String[] values, String[] content) {
      int i = 0;
      StringBuffer sBuf = new StringBuffer();
      String selected = " selected";
    ...
    public static String ComboListMust(String CurrentValue,String[] values, String[] content) {
      int i = 0;
      StringBuffer sBuf = new StringBuffer();
      String selected = " selected";
  ...
  //返回年月格式 2010-7
  public static String formatShortMonth(String strDate){
	  return strDate.substring(0,7).replaceAll("-0", "-");
  }
  
  //返回年月格式 2010-07
  public static String formatMonth(String strDate){
  ...
  public static String htmlReplaceAll(String s){
	  try{
		  StringBuffer sBuf = new StringBuffer();
